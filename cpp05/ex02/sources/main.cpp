...
/*   Updated: 2024/05/21 17:00:23 by tstahlhu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	WernerPlantsGarden( Bureaucrat Werner, Bureaucrat KH) {
...
void	WernerRobotomizesHisTasks(Bureaucrat W, Bureaucrat K) {
	...
	RobotomyRequestForm	form("sticking stamps");
...
int	main( void ) {
	...
	try 
	{
		...
		WernerPlantsGarden(Werner, KH);

	//	WernerRobotomizesHisTasks(Werner, Kerstin);
